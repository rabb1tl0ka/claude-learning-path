...
## Actions
- [x] Explain why the web search tool has an automatic implementation while the text editor tool requires a manual one (owner: claude) — done same session, see [server-tools-vs-client-tools.md](server-tools-vs-client-tools.md)
