...
| ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | [ccaf.cyberskill.world](https://ccaf.cyberskill.world/)                                                                                                           | Free, open web                           | **Closest to the real exam** in both style and difficulty — "if you can pass this one comfortably, you're ready." Multiple later passers independently rated it highest too. |
